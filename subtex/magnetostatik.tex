...
\input{\subtexdir/magnetostatik/stromdichten-und-kontinuitaetsgleichung.tex}

\newpage
\section{Magnetfeld und Biot-Savart-Gesetz}%
\label{sec:magnetfeld}
\input{\subtexdir/magnetostatik/magnetfeld-biot-savart.tex}

\newpage
\section{Multipolentwicklung: Magnetischer Dipol}%
\input{\subtexdir/magnetostatik/multipolentwicklung.tex}

\newpage
\section{Magnetostatik in Materie}%
\input{\subtexdir/magnetostatik/magnetostatik-in-medien.tex}

\newpage
\section{Randwertprobleme in der Magnetostatik}%
\input{\subtexdir/magnetostatik/randwertprobleme.tex}
